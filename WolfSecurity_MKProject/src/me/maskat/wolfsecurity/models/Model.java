...
//	}
	...
	public static Map<Integer, ModelRegion> Regions() { return Plugin.plugin.mapRegions; }
    ...
    public static class Regions {
    	...
    	private static ModelRegion addModel(int regionid, String regionname, int ownerid, boolean protection) { return Regions().putIfAbsent(regionid, new ModelRegion(regionid, regionname, new ArrayList<Integer>(Arrays.asList(ownerid)), protection)); }
...
//    	}
		...
		public static int addRegion(Player player) {
			...
			addModel(regionid, regionname, ownerid, false);
    ...
    public static Map<Integer, ModelUser> Users() { return Plugin.plugin.mapUsers; }
...
//		}
	...
	public static Map<Integer, ModelWolf> Wolves() { return Plugin.plugin.mapWolves; }
...
//		}
    ...
    public static Map<Player, ModelPlayer> Players() { return Plugin.plugin.mapPlayers; }
...
//    	public static ModelPlayer getModel(Player player) { return LandSecurity.plugin.mapPlayers.get(player); }
    	...
    	public static int addPlayer(Player player) throws SQLException {
    		...
    		addModel(player);
    		ModelPlayer modelPlayer = Player(player);
    		modelPlayer.setPlayer(player);
    		modelPlayer.setUserId(userid);
    		int ownregionid = Model.Users.getOwnRegionId(userid);
    		modelPlayer.setOwnRegionId(ownregionid);
    		if(ownregionid > 0)
    			Model.Region(ownregionid).setProtection(player.hasPermission(Config.permissionRegionProtect));
    		modelPlayer.setOwnWolfId(Model.Users.getOwnWolfId(userid));
			if(Config.debug) Bukkit.broadcastMessage("go fix wolf entity....");
			modelPlayer.fixWolfEnity();
			modelPlayer.setInitialized(true);
			return userid;
    	}
