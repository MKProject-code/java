...
import me.eccentric_nz.org.slf4j.event.SubstituteLoggingEvent;
import me.eccentric_nz.org.slf4j.helpers.NOPLoggerFactory;
import me.eccentric_nz.org.slf4j.helpers.SubstituteLogger;
import me.eccentric_nz.org.slf4j.helpers.SubstituteLoggerFactory;
import me.eccentric_nz.org.slf4j.helpers.Util;
import me.eccentric_nz.org.slf4j.impl.StaticLoggerBinder;
...
public final class LoggerFactory {
   ...
   private static String STATIC_LOGGER_BINDER_PATH = "me/eccentric_nz/org/slf4j/impl/StaticLoggerBinder.class";
   ...
   private static boolean messageContainsOrgSlf4jImplStaticLoggerBinder(String msg) {
      if (msg == null) {
         return false;
      } else if (msg.contains("me/eccentric_nz/org/slf4j/impl/StaticLoggerBinder")) {
         return true;
      } else {
         return msg.contains("me.eccentric_nz.org.slf4j.impl.StaticLoggerBinder");
      }
   }
   ...
   private static final void bind() {
      ...
      try {
         ...
         msg = var3.getMessage();
         if (msg != null && msg.contains("me.eccentric_nz.org.slf4j.impl.StaticLoggerBinder.getSingleton()")) {
