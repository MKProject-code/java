...
public class Plugin extends JavaPlugin {
	...
	public void onEnable() {
		...
		Model.hiddenMaterials_world.add(Material.STONE);
		Model.hiddenMaterials_world.add(Material.GRANITE);
		Model.hiddenMaterials_world.add(Material.DIORITE);
		Model.hiddenMaterials_world.add(Material.ANDESITE);
		Model.hiddenMaterials_world.add(Material.GRAVEL);
		Model.hiddenMaterials_world.add(Material.DIRT);
		
		Model.materialsToShow_world.add(Material.DIAMOND_ORE);
		Model.materialsToShow_world.add(Material.GOLD_ORE);
		Model.materialsToShow_world.add(Material.IRON_ORE);
		Model.materialsToShow_world.add(Material.EMERALD_ORE);
		Model.materialsToShow_world.add(Material.COAL_ORE);
		Model.materialsToShow_world.add(Material.LAPIS_ORE);
		Model.materialsToShow_world.add(Material.REDSTONE_ORE);
		
		
		Model.hiddenMaterials_nether.add(Material.NETHERRACK);
		
		Model.materialsToShow_nether.add(Material.NETHER_GOLD_ORE);
		Model.materialsToShow_nether.add(Material.NETHER_QUARTZ_ORE);
		Model.materialsToShow_nether.add(Material.ANCIENT_DEBRIS);
