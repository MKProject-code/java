...
import mkproject.maskat.MiniGamesManager.GamesDatabase.SpleefDatabase;
import mkproject.maskat.Papi.Papi;
import mkproject.maskat.Papi.Utils.Message;

public class SpleefController extends SpleefDatabase {
	...
	protected SpleefController(World world) {
		super(world);
		this.blocksPlatform = Papi.Region.setArea(this.locPlay1, this.locPlay2, this.materialPlay);
