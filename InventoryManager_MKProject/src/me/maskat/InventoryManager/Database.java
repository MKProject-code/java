...
public class Database {
	...
	protected static void initialize(Plugin plugin) {
		...
		Papi.MySQL.createTable(Inv.TABLE,
				...
				+","+Papi.SQL.createColumnParse(Inv.INV_SURVIVAL_EXP, Papi.SQL.ValType.INT, 32, false)
				+","+Papi.SQL.createColumnParse(Inv.INV_CREATIVE_EXP, Papi.SQL.ValType.INT, 32, false)
				+","+Papi.SQL.createColumnParse(Inv.INV_ADVENTURE_EXP, Papi.SQL.ValType.INT, 32, false)
				+","+Papi.SQL.createColumnParse(Inv.INV_SPECTATOR_EXP, Papi.SQL.ValType.INT, 32, false)	
				+","+Papi.SQL.createColumnPrimary(Inv.ID)
		);
	}
